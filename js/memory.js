...
;(function( window ) {
  ...
  Memory.prototype._setupGame = function() {
    ...
    //   <button id="mg__button--restart" class="mg__button">End Game</button>\
    //   </div>';
    ...
    this.gameStartScreenHTML = '<h2 class="mg__start-screen--heading">Welcome to the Memory Game!</h2>\
      ...
      <li><span data-level="1" class = "startbtn">Start</span></li>\
      <input type="button" id = "homebtn" class = "homebtn" value="Back to Home" />\
      </ul>';
  ...
  Memory.prototype._winGame = function() {
    ...
    if (this.options.onGameEnd() === false) {
      this._clearGame();
      this.gameMessages.innerHTML = '<h2 class="mg__onend--heading">Sweet!Open the drawer to get your two candy</h2>\
